...
public class Game {
    ...
    public ArrayList<Render> getRenders() {
        ...
        renders.add(new Render(0, 0, "F:\\Project I_Flappy_Bird\\app\\src\\main\\resources\\lib\\background.png"));
        for (Pipe pipe : pipes)
            renders.add(pipe.getRender());
        renders.add(new Render(0, 0, "F:\\Project I_Flappy_Bird\\app\\src\\main\\resources\\lib\\foreground.png"));
